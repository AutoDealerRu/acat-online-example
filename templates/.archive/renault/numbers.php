                ...
                <td class="table-cell">
                    <?php foreach ($optionG->options as $i => $option) { ?>
                        ...
                        <?php if (!$option->current) {
                            $url = "/{$hrefPrefix}{$type}/{$mark_short_name}/{$model_short_name}/{$modification_short_name}/{$category_short_name}/{$subgroup_short_name}/{$option->subnumber_id}"; ?>
            ...
            <tr class="table-row">
                <td class="table-cell">
                    <?php foreach ($related as $k => $rel) { ?>
                        ...
                        <?php if (!$rel->current) {
                            $url = "/{$hrefPrefix}{$type}/{$mark_short_name}/{$model_short_name}/{$modification_short_name}/{$category_short_name}/{$subgroup_short_name}/{$rel->subnumber_id}"; ?>
