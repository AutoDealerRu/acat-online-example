...
<table class="table imageArea-related active">
    ...
    <?php foreach ($numbers as $key => $number) { ?>
        <tr class="table-row bottom-line to-image" data-index="<?php echo $number->label ?>">
            <td class="table-cell"><?php echo $number->index ?></td>
            <td class="table-cell number-info-cell" data-number-info="<?php echo $key ?>">
                ...
                <div class="modal-number-info">
                    ...
                    <div class="number-info">
                        ...
                        <?php if (property_exists($number,'applicability') && $number->applicability) { ?>
                            <div class="number-info-params">Применяемость: <?php echo $number->applicability ?></div>
                        <?php } ?>
                        <?php if (property_exists($number,'relevance') && $number->relevance) { ?>
                            <div class="number-info-params">Актуальность: <?php echo substr($number->relevance, 8, 2).'.'.substr($number->relevance, 5, 2).'.'.substr($number->relevance, 0, 4) ?></div>
                        <?php } ?>
                        <?php if (property_exists($number,'modification') && $number->modification) { ?>
                            <div class="number-info-params">Модификации: <?php echo $number->modification ?></div>
                        <?php } ?>
                        <?php if (property_exists($number,'amount') && $number->amount) { ?>
                            <div class="number-info-count"><p>Количество: <?php echo $number->amount ?></p></div>
                        <?php } ?>
                    </div>
                </div>
            </td>
            <td class="table-cell"><?php echo $number->number ?></td>
            <td class="table-cell"><?php echo $number->description ?></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
...
<?php if ($abbreviations && is_array($abbreviations) && count($abbreviations) > 0) { ?>
    <table class="table active">
        ...
        <tr class="table-row bottom-line">
            <td class="table-cell" style="max-width: 250px;">Сокращение</td>
        ...
        <?php foreach ($abbreviations as $abbreviation) {?>
            <tr class="table-row bottom-line">
                <td class="table-cell" style="max-width: 250px;"><?php echo $abbreviation->abbreviation?></td>
