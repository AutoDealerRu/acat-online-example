...
<table class="table imageArea-related active">
    ...
    <?php foreach ($groups as $group) {
        $url = "/{$hrefPrefix}{$group->type}/{$group->mark}/{$group->country_short_name}/{$group->directory}/{$group->modification}/{$group->group_short}";
    ...
    ?>
        <tr class="table-row bottom-line to-image" data-index="<?php echo $index ?>">
            <td class="table-cell"><?php echo $group->group_short ?></td>
            <td class="table-cell"><a href="<?php echo $url ?>"><?php echo $group->group_name ?></a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
